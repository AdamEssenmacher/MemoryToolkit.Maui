...
public enum TearDownStrategy
{
    ...
    /// <summary>
    /// Clear managed references such as binding contexts, MAUI behaviors, content references, item sources, item templates, gesture recognizers, formatted text spans, logical children, and resources before disconnecting handlers.
    /// </summary>
    Compartmentalize
}
